...
INSERT INTO `chat_conversations` VALUES ('251be441-6153-4a76-ae68-e6ee5d9f359d','41813700-3306-456e-8bb0-210239e7709e','51fc3eed-350b-415a-91bf-4aeac584e1ce','1f374c8e-0f8d-4a47-ba39-93c5d27538e2','gpt-4o-mini','chat_generic','hola. soy Jasper','4b430faf-358c-4eb0-a193-b7b377d9962e','2026-02-08 21:29:46','2026-02-08 21:29:46');
...
CREATE TABLE `service_catalog` (
  ...
  `name` varchar(120) NOT NULL,
  `nameEs` varchar(120) DEFAULT NULL,
  `description` text NOT NULL,
  `descriptionEs` text DEFAULT NULL,
  `nameEn` varchar(120) DEFAULT NULL,
...
INSERT INTO `service_catalog` VALUES ('8f5ebd89-d3d7-42bb-8628-e2797246785a','chatbot-ticketing','Chatbot Ticketing',NULL,'chat bot para administracion de tickets',NULL,NULL,NULL,1,12.00,240.00,1,'2026-02-13 10:56:25','2026-02-13 10:56:25'),('f1eb0142-05be-11f1-9145-5a0d05a37ed3','chat_generic','Chatbot genérico',NULL,'Servicio conversacional general para FAQ y soporte.',NULL,NULL,NULL,1,49.00,499.00,1,'2026-02-09 13:55:08','2026-02-09 13:55:08'),('f1eb1bbe-05be-11f1-9145-5a0d05a37ed3','chat_ocr','Chatbot OCR',NULL,'Servicio con OCR y consulta sobre documentos.',NULL,NULL,NULL,1,79.00,799.00,1,'2026-02-09 13:55:08','2026-02-09 13:55:08'),('f1eb1c18-05be-11f1-9145-5a0d05a37ed3','chat_sql','Chatbot SQL',NULL,'Servicio para consultas sobre bases de datos.',NULL,NULL,NULL,1,99.00,999.00,1,'2026-02-09 13:55:08','2026-02-09 13:55:08');
...
INSERT INTO `subscription_services` VALUES ('8323b02b-aff9-485e-9cc8-64d1d44d5bdc','28fd3f14-8f3a-4c22-b24f-e395bac7481b','chat_generic','pending',NULL,49.00,'2026-02-09 17:40:20','2026-02-09 17:40:20',NULL),('dc6e85cc-5921-4b8f-9b80-2b3c57aab079','a224ebc1-23c4-4781-9768-2f369c993368','chatbot-ticketing','pending','2026-03-12 22:44:53',12.00,'2026-02-13 11:46:38','2026-02-13 11:46:38',NULL);
...
INSERT INTO `subscriptions` VALUES ('28fd3f14-8f3a-4c22-b24f-e395bac7481b','1ed4bda3-1e79-41dd-9abb-025fb25cd760','pending','monthly',49.00,'EUR','2026-02-09 17:40:20','2026-03-09 17:40:20',0,'2026-02-09 17:40:20','2026-02-09 17:59:14'),('a224ebc1-23c4-4781-9768-2f369c993368','f5f115c3-7f0c-4468-9611-ab4c7ac2ed16','active','monthly',150.00,'EUR','2026-02-12 22:44:53','2026-03-12 22:44:53',0,'2026-02-12 22:44:53','2026-02-13 11:46:38');
...
INSERT INTO `tenant_invoice_items` VALUES ('cf36a7f5-8c9c-4b1e-8e2c-9c4c95055dd0','7cf1c860-ef52-41b7-8298-48f0aeb7b237','chatbot-ticketing','Servicio chatbot-ticketing',12.00,'pending','2026-02-13 11:46:38');
...
CREATE TABLE `tenant_invoices` (
  ...
  `tenantId` varchar(36) NOT NULL,
  `subscriptionId` varchar(36) DEFAULT NULL,
  `paymentRequestId` varchar(36) DEFAULT NULL,
  `period` varchar(16) NOT NULL,
  `basePriceEur` decimal(10,2) NOT NULL DEFAULT 0.00,
...
INSERT INTO `tenant_invoices` VALUES ('7cf1c860-ef52-41b7-8298-48f0aeb7b237','f5f115c3-7f0c-4468-9611-ab4c7ac2ed16','a224ebc1-23c4-4781-9768-2f369c993368','985f46ac-3c71-47ce-8034-8daac05c2bdc','monthly',150.00,12.00,162.00,'EUR','paid','2026-02-12 22:44:53','2026-02-12 22:47:53','2026-02-12 22:44:53','2026-03-12 22:44:53','2026-02-12 22:44:53');
...
CREATE TABLE `tenant_service_configs` (
  ...
  `pricingId` varchar(36) DEFAULT NULL,
...
INSERT INTO `tenant_service_configs` VALUES ('0381181b-910b-41e8-98e2-f9118fae72eb','1ed4bda3-1e79-41dd-9abb-025fb25cd760','chat_generic','active',NULL,NULL,NULL,NULL,'2026-02-11 14:47:19','2026-02-11 14:47:19',NULL),('eb0511f7-b5ab-4829-98c2-deeef94435ce','f5f115c3-7f0c-4468-9611-ab4c7ac2ed16','chatbot-ticketing','active','Eres un asistente virtual especializado en consultar endpoints de una API REST y ayudar a los usuarios a comprar tickets.\nPuedes:\n\nLeer datos desde endpoints REST (eventos disponibles, precios, disponibilidad, detalles).\n\nInterpretar las respuestas en formato JSON.\n\nGuiar al usuario en la selección de eventos.\n\nVerificar disponibilidad.\n\nCrear y confirmar la reserva de tickets mediante los endpoints correspondientes.\n\nDebes ser claro, estructurado y confirmar siempre los datos antes de realizar una compra.\nSi falta información, solicita únicamente los datos necesarios para completar la operación.','500672f6-0365-4cae-a026-129f871875f9','670322fc-0d38-4244-9c8f-431a60d37753','e7fb096e-c466-4205-9465-0948a77f1e70','2026-02-13 11:46:39','2026-02-13 17:30:22',NULL);
...
INSERT INTO `tenant_service_endpoints` VALUES ('40dafa18-6617-4279-af61-bb13f86b690d','f5f115c3-7f0c-4468-9611-ab4c7ac2ed16','chatbot-ticketing','post-v1-chat','POST','/v1/chat',NULL,NULL,1,'2026-02-13 11:46:45','2026-02-13 11:46:45'),('7487779b-02c7-4e75-b043-627dbacd25a1','f5f115c3-7f0c-4468-9611-ab4c7ac2ed16','chatbot-ticketing','get-health','GET','/health',NULL,NULL,1,'2026-02-13 11:46:45','2026-02-13 11:46:45');
...
CREATE TABLE `usage_events` (
  ...
  `serviceCode` varchar(64) DEFAULT NULL,
...
-- Dump completed on 2026-02-13 18:16:58
